...
with [https://bitbucket.org](https://bitbucket.org). Each person maintaining the Data Library should have their own account and
...
* Create a new SSH Key on the Data Library Server
  ...
  _This will create an ssh key in ~/.ssh/id_bitbucket. Set a passphrase for your key that you will use to communicate
