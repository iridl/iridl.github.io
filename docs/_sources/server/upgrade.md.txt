...
* rpm_inventory will be a complete list of all the packages you currently have installed, with their current release
  version.
...
* disk_inventory will tell you what partitions you currently have mounted and how much space is remaining on each disk.
  This is important to determine how to format your hard drive[s] in preparation for the new installation. Take
  particular
